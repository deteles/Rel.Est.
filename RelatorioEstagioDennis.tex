...
\usepackage{afterpage}			% Pacote utilizado para colocar referencia de figura na mesma página
...
\begin{figure}[!htb]
	...
	Fonte: site do CTI Centro de Tecnologia da Informação Renato Archer.\footnotemark
	
	\label{Cerimonia}
\end{figure}

\footnotetext{Figura retirada da URL <http://www.cti.gov.br/dtsd/gesiti/75-semana-nacional-de-ciencia-e-tecnologia-2014-saiu-na-midia/259-ministro-da-ciencia-tecnologia-e-inovacao-participa-de-inauguracao-de-projeto-de-tecnologia-espacial>. Acesso em: 7 out. 2015}
...
\begin{figure}[!htb]
	...
	Fonte: site do IEAV Instituto de Estudos Avançados (2010, p. 9).\footnotemark
	
	\label{Meta2}
\end{figure}

\footnotetext{Figura retirada da URL <http://www.ieav.cta.br/peice2010/Apresentacoes\_PEICE\%202010\_pdf/2010-11-29/0102-Saulo.pdf>. Acesso em: 7 out. 2015.}
